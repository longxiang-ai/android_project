...
public class ClockView extends View {
    ...
    private void drawTimeNeedles(Canvas canvas) {
         ...
         */
        // 时针
        Log.i("In Time Needle Paint","Now hour:"+hour);
        ...
        canvas.drawLine(startX,startY,endX_hour,endY_hour,needlePaint);
        // 分针
        Log.i("In Time Needle Paint","Now minute:"+minute);
        ...
        // 秒针
        Log.i("In Time Needle Paint","Now second:"+second);
        int secondDegree = (second-15) * 6;
        Log.i("In Time Needle Paint","Now secondDegree:"+secondDegree);
        ...
        canvas.drawLine(startX,startY,endX_second,endY_second,needlePaint);
