...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2_transparent = ObjectAnimator.ofFloat(target,"alpha",1f,0.5f);
        animator2_transparent.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animator2_transparent.setRepeatCount(ObjectAnimator.INFINITE);
        animator2_transparent.setRepeatMode(ObjectAnimator.REVERSE);

        // TODO ex2-3: 将上面创建的其他 ObjectAnimator 都添加到 AnimatorSet 中
        animatorSet = new AnimatorSet();
        animatorSet.playTogether(animator1,animator2_x,animator2_y,animator2_transparent);
        animatorSet.start();
    }
}
