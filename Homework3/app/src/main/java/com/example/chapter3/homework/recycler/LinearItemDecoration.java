...
public class LinearItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public static class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        private List<com.example.chapter3.homework.recycler.TestData> mDataset = new ArrayList<>();
        ...
        public interface IOnItemClickListener {
            ...
            void onItemCLick(int position, com.example.chapter3.homework.recycler.TestData data);

            void onItemLongCLick(int position, com.example.chapter3.homework.recycler.TestData data);
        }
